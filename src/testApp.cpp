...
void testApp::setup() {
	...
	kinect1.kindex=1;
		kinect1.init();
		//kinect1.init(true);  // shows infrared instead of RGB video image
		//kinect1.init(false, false);  // disable infrared/rgb video iamge (faster fps)
...
*/
		...
		//	colorImg.setFromPixels(kinect.getPixels(), kinect.width/2, kinect.height/2);
		//	colorImg2.setFromPixels(kinect1.getPixels(), kinect.width/2, kinect.height/2);
	...
	/*	if(bThreshWithOpenCV) {
		...
		//	contourFinder2.findContours(grayImage2, 10, (kinect.width*kinect.height)/2, 20, false);
	}*/
}
...
*/
	kinect.drawDepth(10, 10, 400, 300);
		//	colorImg.draw(10, 320, 400, 300);
		//	contourFinder.draw(10, 320, 400, 300);
	
	kinect1.drawDepth(410, 10, 400, 300);
		//	colorImg2.draw(410, 320, 400, 300);
		//	contourFinder2.draw(410, 320, 400, 300);
